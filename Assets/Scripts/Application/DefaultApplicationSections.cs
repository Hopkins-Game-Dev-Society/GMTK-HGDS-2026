...
namespace BirthdayJobJam.Application
{
    internal static class DefaultApplicationSections
    {
        public static List<ApplicationSectionDefinition> Create()
        {
            ...
            {
                Section(ApplicationSectionId.CreateAccountSignIn, "Create Account/Sign In",
                    Challenge("username", "Username"),
                    Challenge("password", "Password"),
                    Challenge("two_factor_code", "Two-Factor Authentication Code")),

                Section(ApplicationSectionId.MyInformation, "My Information",
                    Challenge("legal_name", "Legal Name"),
                    Challenge("date_of_birth", "Date of Birth"),
                    Challenge("government_id", "Government ID")),

                Section(ApplicationSectionId.MyExperience, "My Experience",
                ...
                Section(ApplicationSectionId.ApplicationQuestionsOne, "Application Questions 1 of 2",
                    Challenge("question_1", "Question 1"),
                    Challenge("question_2", "Question 2"),
                    Challenge("question_3", "Question 3")),

                Section(ApplicationSectionId.ApplicationQuestionsTwo, "Application Questions 2 of 2",
                ...
                Section(ApplicationSectionId.VoluntaryDisclosures, "Voluntary Disclosures",
                ...
                Section(ApplicationSectionId.Review, "Review",
